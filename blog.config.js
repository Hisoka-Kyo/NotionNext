...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hisoka', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的教书匠📖', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xianjianaiedu.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, 知识', // 网站关键词 英文逗号隔开
